  ...
  return (
    <div className="home-container">
      ...
      <main className="home-main">
          ...
          <div className="home-max-width max-content-container">
            <div className="home-content-container">
              <h1 className="home-text Heading1">
                ...
                <br className="home-text06 Heading1"></br>
              </h1>
        ...
        <div id="serviices" className="home-section-one section-container">
          <div className="home-max-width1 max-content-container">
            ...
            <div className="home-cards-container">
              <div className="home-card">
                ...
                <h4 className="home-text18 Heading4">Software Development</h4>
              ...
              <div className="home-card1">
                ...
                <h4 className="home-text22 Heading4">IT Consulting</h4>
              ...
              <div className="home-card2">
                ...
                <h4 className="home-text27 Heading4">Test Automation</h4>
          ...
          <div className="home-max-width2 max-content-container">
            ...
            <div className="home-content-container1">
              <h1 className="home-text33 Heading2">
                ...
                <span className="home-text37">Let us hear your needs.</span>
              </h1>
        ...
        <div id="consulting" className="home-section-three section-container">
          <div className="home-max-width3 max-content-container">
            <div className="home-content-container2">
              <h1 className="home-text42 Heading2">
                <span>The IT Consultancy Service.</span>
                <br></br>
                <br></br>
                <span className="home-text46">Consult with us anytime.</span>
              </h1>
        ...
        <div className="home-section7 section-container">
          <div className="home-max-width5 max-content-container">
            <div className="home-content-container4">
              <h1 className="home-text59"> Get started today. </h1>
